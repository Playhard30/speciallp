...
if (isset($_POST['submit']) && !empty($_SESSION['username'])) {
    ...
    try {
        ...
        $mail->Username   = 'sfaclp2021@gmail.com';                     //SMTP username sfaclp2021@gmail.com
        $mail->Password   = '03132804_J@son';                               //SMTP password 03132804_J@son
        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('sfaclp2021@gmail.com', 'SFAC-LP');
