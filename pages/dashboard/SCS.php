...
?>
<title>
    Enrolled SCS Students | SFAC - Las Piñas
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Enrolled SCS Students</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header m-1 my-0">
                            <h5 class="mb-0 ">Enrolled SCS Students List</h5>
                            ...
                            <table class=" table table-hover responsive nowrap m-0" id="datatable-basic"
                                ...
                                <tbody>
                                    ...
                                    $pendStud = $db->query("SELECT *, CONCAT(S.firstname, ' ', S.middlename, ' ', S.lastname) AS fullname
                                            ...
                                            WHERE remark IN ('Approved') AND C.department_id IN ('3') AND ay_id IN ('$_SESSION[AC]') AND sem_id IN ('$_SESSION[S]')
