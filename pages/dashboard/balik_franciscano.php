...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Enrolled Students (Balik Franciscano)</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header m-1 my-0">
                            <h5 class="mb-0 ">Enrolled Students (Balik Franciscano) List</h5>
                                ...
                                <tbody>
                                    ...
                                    $studentList = mysqli_query(
                                        ...
                                        "SELECT *,CONCAT(tbl_students.lastname, ', ', tbl_students.firstname, ' ', tbl_students.middlename)  as fullname
                                            ...
                                            WHERE remark IN ('Approved') AND bf = 'Yes' AND ay_id IN ('$_SESSION[AC]') AND sem_id IN ('$_SESSION[S]')
