            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="container-fluid py-4">
                    <div class="col-lg-11 mt-lg-0 mt-4 mx-auto">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-sm-auto col-4">
                                    <div class="avatar avatar-xl position-relative">
                                        <?php
                                        $getUserData = mysqli_query($db, "SELECT *, CONCAT(tbl_accounting.account_firstname, ' ', tbl_accounting.account_middlename, ' ', tbl_accounting.account_lastname) AS fullname FROM tbl_accounting WHERE account_id = '$account_id'");
                                ...
                                <form method="POST" enctype="multipart/form-data"
                                    action="userData/ctrl.edit.accounting.php"
                        ...
                        <!-- Card Basic Info -->
                        <form method="POST" enctype="multipart/form-data" action="userData/ctrl.edit.accounting.php"
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            <input id="lastName" name="lname" class="form-control" type="text"
                                                ...
                                                value="<?php echo $row['account_lastname'];
                                                                                                                                                        ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            <input id="firstName" name="fname" class="form-control" type="text"
                                                ...
                                                value="<?php echo $row['account_firstname'];
                                                                                                                                                ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            <input id="middlename" name="mname" class="form-control" type="text"
                                                ...
                                                value="<?php echo $row['account_middlename']; ?>">
                                        </div>
                                    </div>
