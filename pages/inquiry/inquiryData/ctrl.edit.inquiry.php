...
if (isset($_POST['submit'])) {
    ...
    if (!empty($studNoResult)) {
        ...
        $inquiryData = mysqli_query($db, "INSERT INTO tbl_students (img, stud_no, course_id, gender_id, lastname, firstname, middlename, address, birthdate, birthplace, age, religion, citizenship, civilstatus, contact, email, flastname, ffirstname, fmiddlename, fage, foccupation, mlastname, mfirstname, mmiddlename, mage, moccupation, familyincome, nosiblings, glastname, gfirstname, gmiddlename, relationship, gaddress, elem, elemSY, elemAddress, hs, hsSY, hsAddress, lastschool, course_year, lastSY, lastAddress, activation_code, username, password, curri, created_at, last_updated, updated_by) VALUES ('', '$stud_no', '$course', '$gender', '$lastname', '$firstname', '$middlename', '$address', '$birthdate', '$birthplace', '$age', '$religion', '$citizenship', '$civilstatus', '$contact', '$email', '$flastname', '$ffirstname', '$fmiddlename', '$fage', '$foccupation', '$mlastname', '$mfirstname', '$mmiddlename', '$mage', '$moccupation', '$familyincome', '$nosiblings', '$glastname', '$gfirstname', '$gmiddlename', '$relationship', '$gaddress', '$elem', '$elemSY', '$elemAddress', '$hs', '$hsSY', '$hsAddress', '$lastschool', '$courseYear', '$lastSY', '$lastAddress', '', '$username', '$hashedPwd','',CURRENT_TIMESTAMP,'','') ") or die(mysqli_error($db));
