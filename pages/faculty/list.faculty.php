        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">View Faculty Staff List</h6>
                </nav>
                        ...
                        <div class="col-12">
                            <div class="card shadow shadow-xl">
                                ...
                                <div class="card-header">
                                    <h5 class="mb-0">Faculty Staff List</h5>
                                    ...
                                    <table class="table table-flush table-hover" id="datatable-basic">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-sm font-weight-normal"><?php echo $row['updated_at']; ?>
                                                </td>
                                                <td class="text-sm font-weight-normal">
