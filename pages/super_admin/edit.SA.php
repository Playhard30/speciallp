            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="container-fluid py-4">
                    <div class="col-lg-11 mt-lg-0 mt-4 mx-auto">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-sm-auto col-4">
                                    <div class="avatar avatar-xl position-relative">
                                        <?php
                                        $getUserData = mysqli_query($db, "SELECT * FROM tbl_super_admins WHERE sa_id = '$sa_id'");
                                ...
                                <form method="POST" enctype="multipart/form-data" action="userData/ctrl.edit.SA.php"
                        ...
                        <form class="card mt-4 mb-5" id="password" method="POST" action="userData/ctrl.edit.SA.php">
                            <div class="card-header">
