...
if (isset($_POST['submit_new'])) {
    ...
    if ($resultCheck == 0) {
        $addSubj = mysqli_query($db,"INSERT INTO tbl_subjects_new (subj_code,subj_desc, unit_lec, unit_lab, unit_total, prereq, course_id, year_id, sem_id) VALUES ('$subj_code','$subj_desc', '$unit_lec','$unit_lab', '$unit_total', '$prereq', '$course', '$year', '$sem')")or die (mysqli_error($db));
